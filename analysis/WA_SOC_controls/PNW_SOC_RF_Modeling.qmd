...
saveRDS(RF_lrn_tuned_whole, here("analysis/models/MLR3_RFM_Ranger_tuned.rds")) # This is the final model
...
qrf_errdf <- data.frame("LandscapeClass" = c("Full", "Wetland", "Upland"), 
    "RFM.R2_OOB" = c(
      RF_lrn_tuned$train(RF_task)$model$model$r.squared,#RF_rr$aggregate(msrs(c("regr.rsq")))[[1]],
      -999,
      -999
      ),
    "RFM.RMSE_OOB" = c(
      sqrt(RF_lrn_tuned$train(RF_task)$model$model$prediction.error),
      -999,
      -999
      ),
