...
```{r}
instance <- readRDS(here("analysis/models/MLR3_RecursiveFeat_Stocks.rds"))
...
RF_lrn_tuned = lrn("regr.ranger", keep.inbag = FALSE,
                        quantile_response = 0.5,
              quantiles = c(0.025, 0.5, 0.975))
...
```{r}
RF_lrn_tuned <- readRDS(here("analysis/models/MLR3_RFM_Ranger_tuned.rds"))
RF_lrn_tuned$model
```
...
```{r}
RF_rr_acc <- read.csv(here("data/dataframes/MLR3_RFM_Ranger_tuned_CV_results.csv"))
...
predictor <- iml::Predictor$new(RF_lrn_tuned,
                                data = RF_task_feats, 
                                y = RF_task_target)
saveRDS(predictor, here("analysis/models/MLR3_Predictor.rds"))
...
saveRDS(ia_1_plot, file = here("writing/Figures/MLR3_RFM_Interact_1_plot.rds"))
saveRDS(ia_2_plot, file = here("writing/Figures/MLR3_RFM_Interact_2_plot.rds"))
saveRDS(ia_3_plot, file = here("writing/Figures/MLR3_RFM_Interact_3_plot.rds"))
saveRDS(ia_4_plot, file = here("writing/Figures/MLR3_RFM_Interact_4_plot.rds"))
saveRDS(ia_5_plot, file = here("writing/Figures/MLR3_RFM_Interact_5_plot.rds"))
```
...
readr::write_csv(qrf_errdf, file = here("data/dataframes/MLR3_RFM_ErrorDF.csv"))
```
