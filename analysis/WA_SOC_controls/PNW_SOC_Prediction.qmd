...
```{r}
soc_path <- here("data/Rasters/SOC_Predictions/")
...
readr::write_csv(mappedSOC_1m_depths_sum_df, here("data/dataframes/PNW_MapSOC_wetupl_1m.csv"))
```
...
SOC_df <- readr::read_csv(here("data/dataframes/PNW_MapSOC_wetupl_1m.csv"))

SOC_df |> 
  mutate(across(contains("SOC"), ~ . * 100)) |> 
  readr::write_csv(here("data/dataframes/PNW_MapSOC_wetupl_1m_Mgha.csv"))
...
```{r}
hlef_int_rast <- (rast("data/Rasters/SOC_Predictions/PNW_hlef_025_975_SOC_RFM_1m.tif"))
hoh_int_rast <- (rast("data/Rasters/SOC_Predictions/PNW_hoh_025_975_SOC_RFM_1m.tif"))
mas_int_rast <- (rast("data/Rasters/SOC_Predictions/PNW_mas_025_975_SOC_RFM_1m.tif"))
col_int_rast <- (rast("data/Rasters/SOC_Predictions/PNW_col_025_975_SOC_RFM_1m.tif"))
```
...
readr::write_csv(mappedSOC_025_1m_depths_sum_df, "data/dataframes/PNW_mappedSOC_025_1m_depths_sum_df.csv")
readr::write_csv(mappedSOC_975_1m_depths_sum_df, "data/dataframes/PNW_mappedSOC_975_1m_depths_sum_df.csv")
```
