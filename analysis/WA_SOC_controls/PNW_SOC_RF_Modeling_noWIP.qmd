...
# instance$result
# 
# saveRDS(instance, file = "SOIL CARBON/All_WA/analysis/models/MLR3_RecursiveFeat_Stocks_noWIP.rds")
```



```{r}
#instance <- readRDS("SOIL CARBON/All_WA/analysis/models/MLR3_RecursiveFeat_Stocks_noWIP.rds")
...
saveRDS(tune_instance, file = "SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_tune_instance_noWIP.rds")
```



```{r}
tune_instance <- readRDS(file = "SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_tune_instance_noWIP.rds")
...
saveRDS(RF_lrn_tuned, "SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_tuned_noWIP.rds")
...
```{r}
#| eval: false
RF_lrn_tuned <- readRDS("SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_tuned_noWIP.rds")

RF_CV <- rsmp("repeated_cv", repeats = 5, folds = 5)

RF_rr <- mlr3::resample(RF_task, RF_lrn_tuned, RF_CV)
saveRDS(RF_rr, file = "SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_resampling_noWIP.rds")
```


```{r}
RF_rr <- readRDS(file = "SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_resampling_noWIP.rds")
...
write_csv(RF_rr_acc, file = "SOIL CARBON/All_WA/data/dataframes/MLR3_RFM_Ranger_tuned_CV_results_noWIP.csv")
```


```{r}
RF_rr_acc <- read.csv("SOIL CARBON/All_WA/data/dataframes/MLR3_RFM_Ranger_tuned_CV_results_noWIP.csv")
...
saveRDS(ks, file = "SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap_noWIP.rds")
saveRDS(ks_wet, 
        file = "SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap_Wet_noWIP.rds")
saveRDS(ks_upl, 
        file = "SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap_Upl_noWIP.rds")
```

```{r}
ks <- readRDS(file = "SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap_noWIP.rds")
ks_wet <- readRDS(file = "SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap_Wet_noWIP.rds")
ks_upl <- readRDS(file = "SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap_Upl_noWIP.rds")
...
predictor <- iml::Predictor$new(RF_lrn_tuned,
                                data = RF_task_feats, 
                                y = RF_task_target)
saveRDS(predictor, "SOIL CARBON/All_WA/analysis/models/MLR3_Predictor_noWIP.rds")
...
saveRDS(ia_1, 
        file = "SOIL CARBON/All_WA/writing/Figures/MLR3_RFM_Interact_1_plot_noWIP.rds")
saveRDS(ia_2, 
        file = "SOIL CARBON/All_WA/writing/Figures/MLR3_RFM_Ranger_Interact_2_plot_noWIP.rds")
saveRDS(ia_3, 
        file = "SOIL CARBON/All_WA/writing/Figures/MLR3_RFM_Ranger_Interact_3_plot_noWIP.rds")
saveRDS(ia_4, 
        file = "SOIL CARBON/All_WA/writing/Figures/MLR3_RFM_Ranger_Interact_4_plot_noWIP.rds")
saveRDS(ia_5, 
        file = "SOIL CARBON/All_WA/writing/Figures/MLR3_RFM_Ranger_Interact_5_plot_noWIP.rds")
```
...
saveRDS(ia_1_plot, file = "SOIL CARBON/All_WA/writing/Figures/MLR3_RFM_Interact_1_plot_noWIP.rds")
saveRDS(ia_2_plot, file = "SOIL CARBON/All_WA/writing/Figures/MLR3_RFM_Interact_2_plot_noWIP.rds")
saveRDS(ia_3_plot, file = "SOIL CARBON/All_WA/writing/Figures/MLR3_RFM_Interact_3_plot_noWIP.rds")
saveRDS(ia_4_plot, file = "SOIL CARBON/All_WA/writing/Figures/MLR3_RFM_Interact_4_plot_noWIP.rds")
saveRDS(ia_5_plot, file = "SOIL CARBON/All_WA/writing/Figures/MLR3_RFM_Interact_5_plot_noWIP.rds")
```
...
readr::write_csv(qrf_errdf, file = "SOIL CARBON/All_WA/data/dataframes/MLR3_RFM_ErrorDF_noWIP.csv")
```
