...
```{r}
hlef_dat <- data.frame(vect(here("data/points/hlef_pts_6394.gpkg")))
hoh_dat <- data.frame(vect(here("data/points/hoh_pts_2855.gpkg"))) #|> 
mas_dat <- data.frame(vect(here("data/points/mas_pts_2856.gpkg"))) #|> 
col_dat <- data.frame(vect(here("data/points/col_pts_2855.gpkg"))) #|> 
...
readr::write_csv(pnw_dat, here("data/dataframes/PNW_data_MLR3_RFM_LMM.csv"))
...
```{r}
hlef_lab_dat <- data.frame(vect(here("data/points/hlef_lab_pts_6394.gpkg")))
hoh_lab_pts <- data.frame(vect(here("data/points/hoh_lab_pts_2855.gpkg")))
mas_lab_pts <- data.frame(vect(here("data/points/mas_lab_pts_2856.gpkg")))
col_lab_pts <- data.frame(vect(here("data/points/col_lab_pts_2855.gpkg")))
...
readr::write_csv(pnw_dat_lab, here("data/dataframes/PNW_Lab_data_MLR3_RFM_LMM.csv"))
```
...
write.csv(pnw_dat, here("data/dataframes/PNW_data_MLR3_RFM_LMM.csv"))
write.csv(test, here("data/dataframes/Test_data.csv"))
write.csv(train, here("data/dataframes/Train_data.csv"))
write.csv(test.wet, here("data/dataframes/RFM_Test_Wet_data.csv"))
write.csv(test.upl, here("data/dataframes/RFM_Test_Upl_data.csv"))
```
...
write.csv(pnw_dat_lab, here("data/dataframes/PNW_Lab_data_MLR3_RFM_LMM.csv"))
write.csv(testlab, here("data/dataframes/Test_Lab_data.csv"))
write.csv(trainlab, here("data/dataframes/Train_Lab_data.csv"))
write.csv(testlab.wet, here("data/dataframes/RFM_Test_Lab_Wet_data.csv"))
write.csv(testlab.upl, here("data/dataframes/RFM_Test_Lab_Upl_data.csv"))
```
...
write_csv(train_scale, 
          file = here("data/dataframes/PNW_Spline_Stocks_Train_Scale.csv"))
write_csv(train_wet_scale, 
          file = here("data/dataframes/PNW_Spline_Stocks_Train_Wet_Scale.csv"))
write_csv(train_upl_scale, 
          file = here("data/dataframes/PNW_Spline_Stocks_Train_Upl_Scale.csv"))
write_csv(test_scale, 
          file = here("data/dataframes/PNW_Spline_Stocks_Test_Scale.csv"))
write_csv(test_wet_scale, 
          file = here("data/dataframes/PNW_Spline_Stocks_Test_Wet_Scale.csv"))
write_csv(test_upl_scale, 
          file = here("data/dataframes/PNW_Spline_Stocks_Test_Upl_Scale.csv"))
```
...
write_csv(trainlab_scale , 
          file = here("data/dataframes/PNW_Spline_Lab_Train_Scale.csv"))
write_csv(trainlab_wet_scale, 
          file = here("data/dataframes/PNW_Spline_Lab_Train_Wet_Scale.csv"))
write_csv(trainlab_upl_scale, 
          file = here("data/dataframes/PNW_Spline_Lab_Train_Upl_Scale.csv"))
write_csv(testlab_scale, 
          file = here("data/dataframes/PNW_Spline_Lab_Test_Scale.csv"))
write_csv(testlab_wet_scale, 
          file = here("data/dataframes/PNW_Spline_Lab_Test_Wet_Scale.csv"))
write_csv(testlab_upl_scale, 
          file = here("data/dataframes/PNW_Spline_Lab_Test_Upl_Scale.csv"))
