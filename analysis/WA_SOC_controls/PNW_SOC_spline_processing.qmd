...
```{r}
#| eval: false
HLEF_USFS <- openxlsx::read.xlsx("/Users/Anthony/OneDrive - UW/University of Washington/Data and Modeling/HLEF/USFS_Box/HLEF_USFS_Upl.xlsx", 
...
```{r}
#| eval: false
wa_dat <- read.csv(here("data/dataframes/All_WA_horizons.csv")) |> 
...
readr::write_csv(wa_dat_lab, file = here("data/dataframes/All_WA_horizons_pH_PSA_lab.csv"))
```
...
readr::write_csv(pnw_dat_horC, here("data/dataframes/pnw_stocks_data.csv"))
pnw_dat_horC |> group_by(sample_ID) |> summarise(lat = first(lat), lon = first(lon)) |> readr::write_csv(here("data/dataframes/pnw_stocks_latlon_only.csv"))
```
...
readr::write_csv(pnw_dat_horC_lab, here("data/dataframes/pnw_lab_data.csv"))
...
write.csv(pnw_spl_dat_spline_join |> select(-spline_var), 
          file = here("data/dataframes/pnw_spl_datperc_0_15_30_60_100_150_200.csv"))
write.csv(pnw_spl_dat_spline_join |> select(-carbon_perc, -spline_var),
          file = here("data/dataframes/pnw_spl_dat_15_30_60_100_150_200.csv"))
write.csv(pnw_spl_dat_recalc_stocks |> select(-spline_var),
          file = here("data/dataframes/pnw_spl_dat_recalc_stocks_25cm.csv"))
