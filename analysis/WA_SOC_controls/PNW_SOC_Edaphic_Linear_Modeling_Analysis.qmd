...
mod_errdf_lab <- data.frame("LandscapeClass" = c("Full", "Wetland", "Upland"),
                            "LMM.LogMargR2" = c(mumin_R2m_lab, r2_subset_wet$r2_marginal, r2_subset_wet$r2_conditional),
                            "LMM.LogCondR2" = c(mumin_R2c_lab, r2_subset_upl$r2_marginal, r2_subset_upl$r2_conditional),
