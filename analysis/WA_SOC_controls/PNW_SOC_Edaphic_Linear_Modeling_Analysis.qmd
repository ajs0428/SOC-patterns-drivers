...
modlabT1 <- lmer(log10(carbon_perc) ~ 
                  EVI*CHM + WIP*PET_MAP*pH*Clay +LITH + 
...
saveRDS(modlab_dredge_1, file = "SOIL CARBON/All_WA/analysis/models/PNW_Model_Lab_dredge_best.rds")
```
