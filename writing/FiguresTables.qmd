...
```{r}
All_WIP_Acc_DF <- read.csv("SOIL CARBON/All_WA/data/dataframes/All_WIP_Acc_DF.csv")
allsite_WIPimp <- read.csv("SOIL CARBON/All_WA/data/dataframes/PNW_WIP_VarImp.csv")
...
anova_ci_stocks <- read.csv(paste0("SOIL CARBON/All_WA/data/dataframes/anova_best_dredge_model_confint95.csv"))
...
mod_errdf_noWIP <- read.csv("/Users/Anthony/OneDrive - UW/University of Washington/Data and Modeling/SOIL CARBON/All_WA/data/dataframes/PNW_Stocks_model_fit_noWIP.csv")
...
qrf_errdf_noWIP <- read.csv("SOIL CARBON/All_WA/data/dataframes/MLR3_RFM_ErrorDF_noWIP.csv")
...
ensemble_SOC <- read.csv("SOIL CARBON/All_WA/data/dataframes/ensemble_Frac_Estimates_PNW.csv")
```
...
percSOC_table
saveRDS(percSOC_table, file = "SOIL CARBON/All_WA/writing/Tables/SOC_percent_bySite.rds")
```
...
saveRDS(all_lab_ppor_ft, "SOIL CARBON/All_WA/writing/Tables/all_lab_ppor_ft.rds")
saveRDS(all_ppor_ft, "SOIL CARBON/All_WA/writing/Tables/all_ppor_ft.rds")
```
...
```{r}
mappedSOC_025_1m_depths_sum_df <- read.csv("SOIL CARBON/All_WA/data/dataframes/PNW_mappedSOC_025_1m_depths_sum_df.csv") |>  mutate(across(contains("SOC"), ~ . * 100))
mappedSOC_975_1m_depths_sum_df <- read.csv("SOIL CARBON/All_WA/data/dataframes/PNW_mappedSOC_975_1m_depths_sum_df.csv") |>  mutate(across(contains("SOC"), ~ . * 100)) 
...
saveRDS(uncertainty_table_mapped_SOC, "SOIL CARBON/All_WA/writing/Tables/PNW_Uncertainty_Mapped_SOC.rds")
```

NWI wetland areas 
- use wetland area estimates from the mapped data tables
```{r}
NWI_areas_df <- read.csv("SOIL CARBON/All_WA/data/dataframes/PNW_NWI_wetland_areas.csv")
...
PNW_Wet_Area_Table
saveRDS(PNW_Wet_Area_Table, "SOIL CARBON/All_WA/writing/Tables/PNW_Wet_Area_Table.rds")
```
...
est_func <- function(data, coef_string){
  ...
  est_string <- paste0("scaled coefficient estimate = ", 
                      ...
                      est_2.5, " - ", est_97.5)
  print(est_string)
  saveRDS(est_string, paste0("SOIL CARBON/All_WA/writing/in_text_values/",
...
saveRDS(PNW_WIPimp_plot, "SOIL CARBON/All_WA/writing/Figures/PNW_WIPimp_plot.rds")
```
...
model_fit_plots <-( lmm_stocks_plot + ggtitle("LMM")) + (qrf_stocks_plot + ggtitle("RFM")) + lmm_lab_plot + qrf_lab_plot +
...
shap_est_func <- function(ks_df, var_name, stockorlab) {
    saveRDS(ks_df[ks_df$column == var_name, "abs_sum"][[1]], 
            paste0("SOIL CARBON/All_WA/writing/in_text_values/",
                   var_name,
                   "_shap_",
                   stockorlab,
                   ".rds"))
...
lmm_interact_plots
saveRDS(lmm_interact_plots, "SOIL CARBON/All_WA/writing/Figures/lmm_interact_plots.rds")
```
...
ale_geo_qrf$results |> 
  ...
  theme(legend.position='top', 
        ...
        plot.tag = element_text(size = 8, face = "bold"))
ale_rf_stocks
saveRDS(ale_rf_stocks, "SOIL CARBON/All_WA/writing/Figures/ALE_RF_Stocks_Plot.rds")
```
...
saveRDS(ale_rf_lab, "SOIL CARBON/All_WA/writing/Figures/ALE_RF_Lab_Plot.rds")
