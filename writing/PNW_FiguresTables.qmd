...
qrf_stocks_plot <- predict_plot(model = QRFM_stocks, data = test_viz) +
    annotate(geom = "text", x = 1.3, y = 1.8,
             label = as.expression(bquote(R^2 == .(qrf_stocks_r2)))) 

predict_plot(model = QRFM_stocks_noWIP, data = test_viz) +
    annotate(geom = "text", x = 1.3, y = 1.8,
             label = as.expression(bquote(R^2 == .(qrf_stocks_r2))))

qrf_lab_plot <- predict_plot(model = QRFM_lab, data = testlab_viz) + 
    theme(legend.position = "none") +
    annotate(geom = "text", x = 6, y = 9,
...
model_fit_plots <-( lmm_stocks_plot + ggtitle("LMM")) + 
    (qrf_stocks_plot + ggtitle("RFM")) + lmm_lab_plot + qrf_lab_plot +
...
model_fit_plots
saveRDS(model_fit_plots, file = "/Users/Anthony/OneDrive - UW/University of Washington/Data and Modeling/SOIL CARBON/All_WA/writing/Figures/Model_Test_Fit_Scatter.rds")
```
...
ks <- readRDS(file = "/Users/Anthony/OneDrive - UW/University of Washington/Data and Modeling/SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap.rds")
ks_wet <- readRDS(file = "/Users/Anthony/OneDrive - UW/University of Washington/Data and Modeling/SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap_Wet.rds")
ks_upl <- readRDS(file = "/Users/Anthony/OneDrive - UW/University of Washington/Data and Modeling/SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap_Upl.rds")

ks_lab <- readRDS(file = "/Users/Anthony/OneDrive - UW/University of Washington/Data and Modeling/SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap_LabData.rds")
ks_lab_wet <- readRDS(file = "/Users/Anthony/OneDrive - UW/University of Washington/Data and Modeling/SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap_Wet_LabData.rds")
ks_lab_upl <- readRDS(file = "/Users/Anthony/OneDrive - UW/University of Washington/Data and Modeling/SOIL CARBON/All_WA/analysis/models/MLR3_RFM_Ranger_KernelShap_Upl_LabData.rds")
```
...
shap_est_func <- function(ks_df, var_name, stockorlab) {
    saveRDS(ks_df[ks_df$column == var_name, "abs_sum"][[1]], 
            paste0("/Users/Anthony/OneDrive - UW/University of Washington/Data and Modeling/SOIL CARBON/All_WA/writing/in_text_values/",
                   var_name,
                   "_shap_",
                   stockorlab,
                   ".rds"))
